			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<table class="table table-striped" style="text-align: center;background: white">
						...
						<tbody>
							<c:forEach var="roles" items="${listRoles}" varStatus="count">
								<tr>

									<th scope="row">${count.count  }</th>
									<td style="text-align: left">${roles.nameRoles}</td>
									<td><a
										style="width: 50px; high: 50px; border-color: #00E5EE; border-radius: 100%;"
										class="btn btn-outline-info "
										href="<c:url value="/mvpquanliduan/roles/show-form-edit/${roles.idRoles }" />"
										title=""><i class="ft-edit"></i></a><button
											style="width: 50px; high: 50px; border-color: #FF6A6A; border-radius: 100%;"
											data-href="<c:url value="/mvpquanliduan/roles/delete/${roles.idRoles }" />"
