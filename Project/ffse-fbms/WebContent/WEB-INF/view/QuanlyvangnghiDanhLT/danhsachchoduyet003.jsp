										...
										<ul class="pagination">
											<c:if test="${currentPage != 1}">
												...
												<li class="paginate_button page-item previous"
													...
													href="<%=request.getContextPath()%>/QuanlyvangnghiDanhLT/danhsachchoduyet003?page=${currentPage-1}"
											...
											<li class="paginate_button page-item "><a
												href="<%=request.getContextPath()%>/QuanlyvangnghiDanhLT/danhsachchoduyet003?page=${currentPage}"
											...
											<li class="paginate_button page-item last"
												...
												href="<%=request.getContextPath()%>/QuanlyvangnghiDanhLT/danhsachchoduyet003?page=${lastPage}"
