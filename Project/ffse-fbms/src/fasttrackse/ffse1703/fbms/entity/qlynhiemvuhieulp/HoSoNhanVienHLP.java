...
public class HoSoNhanVienHLP {
	...
	public String toString() {
		return "HoSoNhanVien [maNhanVien=" + maNhanVien + ", anhDaiDien=" + anhDaiDien + ", email=" + email
				+ ", gioiTinh=" + gioiTinh + ", hoDem=" + hoDem + ", namSinh=" + namSinh + ", soDienThoai="
				+ soDienThoai + ", ten=" + ten + ", trangThai=" + trangThai + ", phongBan=" + phongBan + ", chucDanh="
				+ chucDanh + "]";
	}
}
