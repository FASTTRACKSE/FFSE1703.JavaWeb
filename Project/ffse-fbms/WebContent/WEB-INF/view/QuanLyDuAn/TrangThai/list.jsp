			...
			<div class="row mb-2">
				<form class="col-xs-12"
					...
					<div class="pull-right">
						<a href="<c:url value="/qlda/trangthai/add_form"></c:url>"
										...
										<c:forEach var="item" items="${list}" begin="0"
											...
											<tr>
												...
												<td class="tbl_actions"><a
													href="<c:url value="/qlda/trangthai/view/${item.maTrangThai}" />"
													title="view"> <i class="fa fa-eye" aria-hidden="true"></i>view
												</a> <a
													href="<c:url value="/qlda/trangthai/edit_form/${item.maTrangThai}" />"
													title="Sửa"> <i class="fa fa-pencil-square-o blue"
														aria-hidden="true"></i>Sửa
												</a> <a
													href="<c:url value="/qlda/trangthai/delete/${item.maTrangThai}" />"
													title="Xóa"
