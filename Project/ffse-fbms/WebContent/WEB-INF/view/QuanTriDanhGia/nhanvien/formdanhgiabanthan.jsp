						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-content collpase show">
									<div class="card-body">
										<form:form cssClass="form form-horizontal form-bordered" method="POST">
											<div class="form-body">
											...
											<div class="form-actions">
												<a href="<c:url value="/quantridanhgia/danhgiabanthan/"/>" class="btn btn-danger btn-min-width mr-1 mb-1">Trở về</a>
												<c:if test="${command.trangThai == 1 }">
													<button type="submit" formaction="<c:url value="/quantridanhgia/danhgiabanthan/"/>/update" class="btn btn-success btn-min-width mr-1 mb-1">Cập nhật</button>
												</c:if>
												<c:if test="${command.trangThai == 0 }">
													<button type="submit" formaction="<c:url value="/quantridanhgia/danhgiabanthan/"/>/drafts" class="btn btn-info btn-min-width mr-1 mb-1">Lưu nháp</button>
													<button type="submit" formaction="<c:url value="/quantridanhgia/danhgiabanthan/"/>/new" class="btn btn-success btn-min-width mr-1 mb-1">Tạo</button>
												</c:if>
											</div>
										</form:form>
									</div>
