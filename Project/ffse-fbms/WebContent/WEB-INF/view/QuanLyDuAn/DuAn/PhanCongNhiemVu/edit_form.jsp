...
<div class="app-content content container-fluid">
	...
	<form:form method="POST"
		action="/ffse-fbms/qlda/DuAn/PhanCongNhiemVu/edit"
		...
		<input name="oldVaitro" type="text" value="${nhiemvu.maVaiTro }" />
		<input name="oldVaitro" type="text" value="${nhiemvu.maNhanVien }" />
		<div class="form-group col-sm-6">
			<label>Tên Vendor</label>

			<form:select path="nhiemvu.maVaiTro" cssClass="form-control" mutiple="true"
				style="height:calc(2.95rem - 2px);">
				<c:forEach items="${vaitro}" var="vd">
					<option value="${vd.mavt}">${vd.tenvt}</option>
				</c:forEach>
				<form:errors path="nhiemvu.maVaiTro" cssStyle="color: red"></form:errors>
