...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2018 at 07:53 PM
...
CREATE TABLE `dan_toc` (
  `ma_dan_toc` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `ten_dan_toc` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `hop_dong` (
  ...
  `hop_dong_tu_ngay` date NOT NULL,
  `hop_dong_den_ngay` date NOT NULL,
...
INSERT INTO `hop_dong` (`ma_hop_dong`, `ma_nhan_vien`, `ma_loai_hop_dong`, `luong_thang_13`, `so_ngay_phep`, `ngay_ky`, `hop_dong_tu_ngay`, `hop_dong_den_ngay`, `trang_thai`, `isdelete`) VALUES
(00017, 00002, 3, 1, 12, '2018-09-01', '2018-08-31', '2018-09-30', 1, 0),
(00020, 00001, 3, 1, 1, '2018-09-06', '2018-09-06', '2018-09-07', 2, 1),
(00022, 00001, 5, 1, 10, '2018-09-07', '2018-09-06', '2018-09-15', 1, 0),
(00023, 00002, 2, 2, 12, '2018-09-08', '2018-09-08', '2018-09-28', 1, 1),
(00024, 00002, 2, 2, 12, '2018-09-08', '2018-09-08', '2018-09-28', 1, 0),
(00025, 00001, 5, 2, 12, '2018-09-29', '2018-09-27', '2018-09-28', 1, 0),
(00026, 00002, 4, 1, 13, '2018-09-08', '2018-09-01', '2018-09-08', 1, 1),
(00027, 00001, 4, 1, 12, '2018-09-04', '2018-09-12', '2018-09-23', 1, 0),
(00028, 00001, 4, 1, 1, '2018-09-06', '2018-09-13', '2018-09-28', 1, 0),
(00029, 00001, 4, 1, 13, '2018-09-23', '2018-09-23', '2018-09-09', 1, 0),
(00030, 00001, 4, 1, 16, '2018-09-22', '2018-09-07', '2018-09-02', 1, 0),
(00031, 00001, 4, 2, 13, '2018-09-30', '2018-09-23', '2018-09-23', 1, 0),
(00032, 00001, 2, 2, 12, '2018-09-30', '2018-09-30', '2018-09-22', 1, 1),
(00033, 00001, 2, 2, 10, '2018-10-27', '2018-10-13', '2018-10-13', 2, 1),
(00034, 00001, 3, 2, 10, '2018-10-07', '2018-10-06', '2018-10-28', 1, 1);
...
--
-- Table structure for table `ho_so_nhan_vien_tt`
--

CREATE TABLE `ho_so_nhan_vien_tt` (
  `ma_nhan_vien` int(5) UNSIGNED ZEROFILL NOT NULL,
  `ma_phong_ban` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `ma_chuc_danh` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `ten_nhan_vien` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `anh_dai_dien` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `nam_sinh` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `gioi_tinh` int(1) NOT NULL,
  `ma_tinh_trang_hon_nhan` int(11) NOT NULL,
  `dia_chi` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `ma_thanh_pho` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `ma_quan_huyen` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `ma_xa_phuong` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `ma_dan_toc` int(5) NOT NULL,
  `ma_quoc_tich` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `so_dien_thoai` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `so_cmnd` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `noi_cap` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `ngay_cap` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `trang_thai` int(1) NOT NULL,
  `isdelete` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `ho_so_nhan_vien_tt`
--

INSERT INTO `ho_so_nhan_vien_tt` (`ma_nhan_vien`, `ma_phong_ban`, `ma_chuc_danh`, `ten_nhan_vien`, `anh_dai_dien`, `nam_sinh`, `gioi_tinh`, `ma_tinh_trang_hon_nhan`, `dia_chi`, `ma_thanh_pho`, `ma_quan_huyen`, `ma_xa_phuong`, `ma_dan_toc`, `ma_quoc_tich`, `so_dien_thoai`, `email`, `so_cmnd`, `noi_cap`, `ngay_cap`, `trang_thai`, `isdelete`) VALUES
(00001, 'PGD', 'GD', 'Trần Thị Tâm ', 'WIN_20180528_11_03_58_Pro.jpg', '1999-04-02', 2, 1, 'phước thượng', '01', '001', '00001', 7, 'VN', '01656947165', 'tranthitam@gmail.com', '206262821', 'Đà Nẵng', '2016-05-25', 1, 1),
(00010, 'PGD', 'GD', 'Nguyễn Thị Nhung', 'images (2).jpg', '1975-09-05', 2, 2, '300 Ngô Quyền', '48', '493', '20269', 1, 'VN', '0168243434', 'ffse1703020@gmail.com', '206433545', 'đà nẵng', '1988-12-02', 1, 1),
(00012, 'PDT', 'PM', 'Trần Văn Tôi', 'images.jpg', '1965/02/04', 1, 2, 'thôn An Nguy', '52', '542', '21610', 1, 'VN', '0165346386', 'ffse1703021@gmail.com', '20634343', 'Bình Định', '1980-10-03', 1, 1),
(00013, 'PDA', 'GD', 'tyui', 'Screenshot (23).png', '1233', 1, 2, '45454', '22', '194', '06742', 14, 'AW', '64567657', 'FFSE1702029@st.fasttrack.edu.vn', '', 'đà nẵng', '2018-09-06', 1, 0),
(00014, 'PDT', 'PGD', 'Trần Thị Tâm', 'Screenshot (46).png', '1999-04-02', 1, 1, '45454', '25', '238', '08632', 13, 'AT', '23456789', 'FFSE1702029@st.fasttrack.edu.vn', '12345678', 'đà nẵng', '2018-09-18', 1, 0),
(00015, 'PGD', 'PGD', 'dvdf', 'Screenshot (17).png', '1999-04-02', 1, 1, 'fgh', '12', '107', '03454', 17, 'BA', '01656947165', 'FFSE1702029@st.fasttrack.edu.vn', '12345678', 'đà nẵng', '', 1, 0),
(00016, 'PKT', 'NV', 'Trần Thị Tình', 'download (2).jpg', '2003-09-05', 2, 1, 'thôn ân hoàn', '52', '544', '21690', 1, 'VN', '0393453466', 'tranthitinh@gmail.com', '2343556556', 'Bình Định', '2018-10-05', 1, 1),
(00017, 'PDA', 'NV', 'Trần Thị Tiền', 'download.jpg', '2000-10-03', 2, 1, 'Tổ 1', '52', '544', '21690', 1, 'VN', '0134654563', 'FFSE1702029@st.fasttrack.edu.vn', '206453534', 'Bình Định', '2018-10-03', 1, 1),
(00018, 'PNS', 'NV', 'Trần Đình Tuấn', 'images (1).jpg', '1999-07-20', 1, 3, 'thôn Tân Đông Tây', '49', '509', '20665', 1, 'VN', '01656947165', 'ffse1703020@gmail.com', '206363047', 'Quảng Nam', '2018-10-04', 1, 1),
(00019, 'PDA', 'NV', 'Trần Thị Tâm', 'Screenshot (17).png', '1233', 1, 2, 'FGH', '26', '244', '08755', 19, 'BB', '64567657331', 'FFSE1702029@st.fasttrack.edu.vn', '12345678', 'đà nẵng', '2018-10-18', 1, 0),
(00020, 'PDA', 'NV', 'Trần Văn Vũ', 'download (2).jpg', '1992-08-16', 1, 1, 'tổ 9', '02', '024', '00688', 1, 'VN', '0174635465', 'FFSE1702032@st.fasttrack.edu.vn', '206234345', 'Đà Nẵng', '2018-10-03', 1, 0),
(00021, 'PDA', 'PGD', '', 'download (2).jpg', '1999-04-02', 1, 1, 'gdsfg', '26', '244', '08752', 2, 'AW', '64567657331', 'ffse1703020@gmail.com', '12345678', 'đà nẵng', '2018-10-10', 1, 1),
(00022, 'PDA', 'GD', 'Trần Thị Tâm', 'download.jpg', '1999-04-02', 1, 1, 'gdsfg', '26', '252', '09124', 18, 'BA', '64567657331', 'FFSE1702029@st.fasttrack.edu.vn', '12345678', 'đà nẵng', '2018-10-04', 1, 1);
...
CREATE TABLE `quan_huyen` (
  `ma_quan_huyen` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ten_quan_huyen` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `loai` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ma_thanh_pho` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `quan_huyen` (`ma_quan_huyen`, `ten_quan_huyen`, `loai`, `ma_thanh_pho`) VALUES
...
CREATE TABLE `thanh_pho` (
  `ma_thanh_pho` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ten_thanh_pho` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `loai` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `thanh_pho` (`ma_thanh_pho`, `ten_thanh_pho`, `loai`) VALUES
...
CREATE TABLE `thong_tin_bang_cap` (
  ...
  `noi_cap` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `ngay_cap` date NOT NULL,
  `isdelete` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `thong_tin_bang_cap` (`id`, `ma_nhan_vien`, `ten_bang_cap`, `loai_bang_cap`, `don_vi_cap`, `noi_cap`, `ngay_cap`, `isdelete`) VALUES
(1, 00201, 'Cử nhân công nghệ thông tin', 'Khá', 'Cao đẳng công nghệ thông tin', 'Đà Nẵng', '2016-06-20', 1),
(2, 00202, 'Cử nhân kinh doanh', 'Giỏi', 'Đại Học Duy Tân', 'Đà Nẵng', '2018-09-10', 0),
(3, 00201, 'Cử nhân công nghệ thông tin', 'Khá', 'Cao đẳng công nghệ thông tin', 'Đà Nẵng', '2016-06-20', 0),
(4, 00202, 'Cử nhân kinh doanh', 'Giỏi', 'Đại Học Duy Tân', 'Đà Nẵng', '2018-09-10', 0),
(5, 00204, 'hhhhh', 'giỏi', 'đại học fpt', 'hà nội', '2018-09-28', 0),
(6, 00002, 'Chứng Chỉ TOEIC 450', 'Khá', 'Fast Track SE', 'Đà Nẵng', '2018-09-28', 1),
(7, 00001, 'Cử nhân công nghệ thông tin', 'giỏi', 'Cao đẳng công nghệ thông tin', 'Đà Nẵng', '2016-06-20', 0),
(8, 00001, 'Cử nhân công nghệ thông tin', 'giỏi', 'Cao đẳng công nghệ thông tin', 'Đà Nẵng', '2016-06-20', 1),
(9, 00001, 'Cử nhân công nghệ thông tin', 'Khá', 'Đại Học Duy Tân', 'Đà Nẵng', '2016-06-20', 1),
(10, 00002, 'chứng chỉ java web', 'ttrung bình', 'fasttrack SE', 'đà nẵng', '2018-09-19', 1),
(11, 00018, 'Tiến Sĩ Công Nghệ Thông Tin', 'Giỏi', 'EF International Language Campus - English courses in New York', 'New York', '2018-10-10', 1);
...
INSERT INTO `thong_tin_gia_dinh` (`id`, `ma_nhan_vien`, `ten`, `que_quan`, `nam_sinh`, `gioi_tinh`, `so_dien_thoai`, `quan_he`, `isdelete`) VALUES
(1, 00001, 'Trần Văn', 'Đà Nẵng', '1992-05-07', 1, '01266676809', 'Anh', 0),
(2, 00001, 'Trần Đình Tuấn', 'Quảng Nam', '1999-09-14', 1, '01203735232', 'Cha', 1),
(3, 00001, 'Nguyễn Thị ánh Tuyết', 'Quảng Nam', '2000-09-05', 2, '0192653923', 'Con Ruột', 1),
(4, 00018, 'Trần Văn A', 'mmmm', '2018-09-15', 1, '11123232333', 'Chaj', 1),
(5, 00001, 'Châu Nguyễn Sa My', 'Đài Loan', '2018-10-10', 2, '098765445', 'Con', 1);
...
CREATE TABLE `xa_phuong` (
  `ma_xa_phuong` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ten_xa_phuong` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `loai` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ma_quan_huyen` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `xa_phuong` (`ma_xa_phuong`, `ten_xa_phuong`, `loai`, `ma_quan_huyen`) VALUES
...
--
-- Indexes for table `ho_so_nhan_vien_tt`
--
ALTER TABLE `ho_so_nhan_vien_tt`
  ADD PRIMARY KEY (`ma_nhan_vien`),
  ...
  ADD KEY `ma_dan_toc` (`ma_dan_toc`),
  ADD KEY `ma_thanh_pho` (`ma_thanh_pho`),
  ADD KEY `ma_quan_huyen` (`ma_quan_huyen`),
  ADD KEY `ma_xa_phuong` (`ma_xa_phuong`);
...
--
ALTER TABLE `hop_dong`
  MODIFY `ma_hop_dong` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `ho_so_nhan_vien_tt`
--
ALTER TABLE `ho_so_nhan_vien_tt`
  MODIFY `ma_nhan_vien` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `loai_hop_dong`
--
ALTER TABLE `loai_hop_dong`
  MODIFY `ma_loai_hop_dong` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tinh_trang_hon_nhan`
  MODIFY `ma_tinh_trang_hon_nhan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Constraints for table `ho_so_nhan_vien_tt`
--
ALTER TABLE `ho_so_nhan_vien_tt`
  ADD CONSTRAINT `ho_so_nhan_vien_tt_ibfk_1` FOREIGN KEY (`ma_phong_ban`) REFERENCES `phong_ban` (`ma_phong_ban`),
  ADD CONSTRAINT `ho_so_nhan_vien_tt_ibfk_2` FOREIGN KEY (`ma_chuc_danh`) REFERENCES `chuc_danh` (`ma_chuc_danh`),
  ADD CONSTRAINT `ho_so_nhan_vien_tt_ibfk_3` FOREIGN KEY (`ma_quoc_tich`) REFERENCES `quoc_tich` (`ma_quoc_tich`),
  ADD CONSTRAINT `ho_so_nhan_vien_tt_ibfk_4` FOREIGN KEY (`ma_tinh_trang_hon_nhan`) REFERENCES `tinh_trang_hon_nhan` (`ma_tinh_trang_hon_nhan`);
COMMIT;
