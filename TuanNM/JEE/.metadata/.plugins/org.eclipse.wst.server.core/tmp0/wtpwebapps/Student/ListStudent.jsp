...
<body>
	...
	<div class="dropdown" style="width: 20%; float: right; text-align: center">
		  ...
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
		    <a class="dropdown-item" href="student?lang=mesagers">English</a>
		    <a class="dropdown-item" href="studnet?lang=resousces_vn_VN">Vietnam</a>
		  </div>
		</div>
				...
				<c:forEach var="Student" items="${listStudent}">
					<tr>
						...
						<td><a href="edit?code=<c:out value='${Student.code}' />"
							...
							<button data-href="delete?lang=${lang}&code=${Student.code}"
				...
				<div class="col col-xs-8">
					<ul class="pagination hidden-xs pull-right">
						<c:forEach var="i" begin="1" end="${total+1}">
							<li><a href="Student?page=${i}&lang=${lang}"><c:out value="${i}" /></a></li>
						</c:forEach>
					</ul>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p><fmt:message key="mesager_del"/></p>
				</div>
