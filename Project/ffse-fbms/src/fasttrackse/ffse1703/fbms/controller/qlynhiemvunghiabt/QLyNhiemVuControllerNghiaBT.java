...
import fasttrackse.ffse1703.fbms.service.qlynhiemvunghiabt.*;
...
//	}
	...
	public String createCongViec(Model model, @ModelAttribute("NhiemVu") @Valid NhiemVu cv, HttpServletRequest request) throws IllegalStateException {
		cv.setIsDelete(0);
	...
	public String edit(Model model, @ModelAttribute("NhiemVu") @Valid NhiemVu NhiemVu, HttpServletRequest request
			)
