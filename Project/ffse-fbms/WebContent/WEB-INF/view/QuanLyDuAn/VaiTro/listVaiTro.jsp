...
<div class="app-content content container-fluid">
	<div class="content-wrapper">
		<div class="row">
			...
			<div class="col-sm-4">
				<h1>
					<strong>Vai Trò Thành Viên</strong>
				</h1>
			</div>
		</div>
				...
				<tbody>
					<c:forEach var="vt" items="${list}">
						<tr>
							...
							<td>${vt.tenvt}</td>
							<td><a
								href="/ffse-fbms/QuanLyDuAn/VaiTro/edit/${vt.mavt}"
								data-toggle="tooltip" title="edit">
									<button type="button" class="btn btn-icon btn-outline-warning">
										<i class="fa fa-pencil"></i>
									</button>
							</a> <a href="/ffse-fbms/QuanLyDuAn/VaiTro/delete/${vt.mavt}">
									<button type="button"
		...
		<div class="col-sm-4">
			<h5>
				<a href="/ffse-fbms/QuanLyDuAn/VaiTro/add"><strong>Thêm Vendor</strong></a>
			</h5>
