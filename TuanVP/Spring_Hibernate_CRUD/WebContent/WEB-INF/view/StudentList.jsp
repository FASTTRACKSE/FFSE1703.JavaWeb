...
<body>
	<div class="container">
		...
		<h3>
			<a href="<c:url value ="/add"/>"><spring:message code="them" /></a>
		</h3>
			...
			<tbody>
				<c:forEach var="sv" items="${list }">
					<tr>
						...
						<td>
							<a href="<c:url value ="/edit/${sv.maSV }"/>" class="btn btn-success">
								<spring:message code="sua" />
							</a> 
							<a href="<c:url value ="/delete/${sv.maSV }"/>" onclick="return confirm('Bạn có muốn xóa sinh viên này?');" class="btn btn-danger">
			...
			<ul class="pagination">
				<c:if test="${page > 1 }">
					<li class="page-item"><a class="page-link"
						href="<c:url value ="/list/1"/>"> <spring:message
								code="trangdau" />
					</a></li>
					<li class="page-item"><a class="page-link"
						href="<c:url value ="/list/${page-1}"/>">${page-1}</a>
					</li>
				</c:if>
				<li class="page-item">
				...
				<c:if test="${page < total }">
					<li class="page-item">
						<a class="page-link" href="<c:url value ="/list/${page+1}"/>">${page+1}</a>
					</li>
					<li class="page-item">
						<a class="page-link" href="<c:url value ="/list/${total}"/>">
