...
<div class="content-header row">
		...
		<form:form method="POST" action="/ffse-fbms/qlda/Database/update"
			...
			<label>Mã Framework</label>
				<form:input class="form-control" path="ma_framework"  readonly="true"
					placeholder="Mã Framework " />
				<form:errors path="ma_framework"  readonly="true" cssStyle="color: red"></form:errors>
			</div>
			<div class="form-group col-sm-6">
