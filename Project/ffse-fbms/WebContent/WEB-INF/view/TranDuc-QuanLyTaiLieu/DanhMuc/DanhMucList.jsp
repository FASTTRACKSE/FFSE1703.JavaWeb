			...
			<div class="content-header-right col-md-3 col-xs-12">
				<div role="group" aria-label="Button group with nested dropdown"
					...
					<a class="btn btn-primary"
						href='<c:url value = "/TranDuc-QuanLyTaiLieu/DanhMuc/add" />'>Thêm Mới<span
												...
												<c:forEach var="item" items="${listDanhMuc}" begin="0"
													...
													<tr>
														...
														<td class="tbl_actions"><a
															...
															href="<c:url value="/TranDuc-QuanLyTaiLieu/DanhMuc/sua/${item.maDM}" />"
															title="Sửa"> <i class="fa fa-pencil-square-o blue"
																aria-hidden="true"></i>
														</a> <a
															href="<c:url value="/TranDuc-QuanLyTaiLieu/DanhMuc/xoa/${item.maDM}" />"
															title="Xóa"
