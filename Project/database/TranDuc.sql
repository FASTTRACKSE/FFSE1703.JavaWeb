...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2018 at 08:29 AM
...
INSERT INTO `icon` (`ma_icon`, `link_File`) VALUES
('pdf', 'asdasd'),
('png', 'occhochuong'),
('txt', 'qwerqwer'),
('unknow', '');
...
INSERT INTO `tai_lieu` (`id_tai_lieu`, `ma_tai_lieu`, `ma_danh_muc`, `ma_icon`, `ten_tai_lieu`, `ma_phong_ban`, `mo_taTL`, `Link`, `ma_trang_Thai`) VALUES
(6, '123', 'IT', 'png', 'quan_ly_mon_hoc.png', 'PIT', 'wergwerg', 'D:\\Github\\FFSE1703.JavaWeb\\Project\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\ffse-fbms\\upload', 'Draft'),
(12, 'btrneyn', 'IT', 'png', 'quan_ly_lop_hoc.png', 'PGD', 'ymrm', 'D:\\Github\\FFSE1703.JavaWeb\\Project\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\ffse-fbms\\upload', 'Wait'),
(13, '123512351235', 'IT', 'png', 'quan_ly_sinh_vien.png', 'PIT', 'qweqwe', 'D:\\Github\\FFSE1703.JavaWeb\\Project\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\ffse-fbms\\upload', 'Wait'),
(29, 'qwerqwerqwer', 'EN', 'png', 'quan_ly_lop_hoc.png', 'PDT', 'qwerqwer', 'D:\\Github\\FFSE1703.JavaWeb\\Project\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\ffse-fbms\\upload', 'Wait'),
(47, 'qwerqwer', 'IT', 'png', 'quan_ly_sinh_vien.png', 'PDT', 'Tai Lieu', 'D:\\Github\\FFSE1703.JavaWeb\\Project\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\ffse-fbms\\upload\\quan_ly_sinh_vien.png', 'Wait'),
(52, 'qưeqweqwe', 'IT', 'png', 'quan_ly_sinh_vien.png', 'PDT', 'ưqeqe', 'D:\\Github\\FFSE1703.JavaWeb\\Project\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\ffse-fbms\\upload\\quan_ly_sinh_vien.png', 'Wait');
...
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`ma_tai_khoan`), ADD UNIQUE KEY `ma_nhan_vien` (`ma_nhan_vien`), ADD UNIQUE KEY `username_UNIQUE` (`username`), ADD UNIQUE KEY `UKr43af9ap4edm43mmtq01oddj6` (`username`);
...
--
ALTER TABLE `tai_lieu`
MODIFY `id_tai_lieu` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=53;
--
