...
public class mainApp {
	...
	public static void main(String[] args) {
		...
		//giảng viên
		GiangVien giangVienThanh = new GiangVien("Thầy Thành", "thanhcl@fasttrack.edu.vn","0910021212");
		GiangVien giangVienLam =  new GiangVien("Thầy Lâm", "lamnt@fasttrack.edu.vn","0910021212");
		GiangVien giangVienThang = new GiangVien("Thầy Thắng", "thangtm@fasttrack.edu.vn","0910021212"); 
		
		GiangVien giangVienHong = new GiangVien("Cô Hồng", "hongltm@fasttrack.edu.vn","0910021212"); 
		GiangVien giangVienHa = new GiangVien("Cô Hà", "hattd@fasttrack.edu.vn","0910021212");
		...
		monTiengAnh.add(new MonAnh("Tiếng Anh cơ bản", "Level 1", giangVienHong, giangVienHa));
		monTiengAnh.add(new MonAnh("E4IT1", "Level 1", giangVienHong, giangVienHa));
		...
		monTiengAnh.add(new MonAnh("Tiếng Anh chuyên ngành", "Level 2", giangVienHong, giangVienHa));
		monTiengAnh.add(new MonAnh("E4IT2", "Level 2", giangVienHong, giangVienHa));
		...
		monThucTap.add(new MonThucTap("F-COMPLEX", new GiangVien("Thầy Thành", "thanhcl@fasttrack.edu.vn","0910021212")));
		monThucTap.add(new MonThucTap("GAMELOFT", new GiangVien("Thầy Nghiêm", "nghiemfe@fasttrack.edu.vn","0910021212")));
		...
		lopHoc.add(new LopHoc("1703", new DaoTaoDaiHan(hocKy), sinhVienLopHoc));

		sinhVienLopHoc = new ArrayList<>();
		sinhVienLopHoc = sinhVien.subList(5, 9);
		
		lopHoc.add(new LopHoc("1704", new DaoTaoDaiHan(hocKy), sinhVienLopHoc));
		
		sinhVienLopHoc = new ArrayList<>();
		sinhVienLopHoc = sinhVien.subList(10, 14);
		
		lopHoc.add(new LopHoc("1801", new DaoTaoNganHan(hocKyJava), sinhVienLopHoc));
		
		sinhVienLopHoc = new ArrayList<>();
		sinhVienLopHoc = sinhVien.subList(15, 19);
		
		lopHoc.add(new LopHoc("1802", new DaoTaoNganHan(hocKyWeb), sinhVienLopHoc));
