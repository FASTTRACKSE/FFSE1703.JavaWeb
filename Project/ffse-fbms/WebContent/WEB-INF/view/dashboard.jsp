                ...
                <div id="recent-buyers" class="list-group height-300 position-relative">
                    <a href="#" class="list-group-item list-group-item-action media no-border">
                        <div class="media-left">
                            <span class="avatar avatar-md avatar-online"><img class="media-object rounded-circle" src="<c:url value="/resources/images/portrait/small/avatar-s-7.png"/>" alt="Generic placeholder image">
                            <i></i>
                            </span>
                        </div>
                    ...
                    <a href="#" class="list-group-item list-group-item-action media no-border">
                        <div class="media-left">
                            <span class="avatar avatar-md avatar-away"><img class="media-object rounded-circle" src="<c:url value="/resources/images/portrait/small/avatar-s-8.png"/>" alt="Generic placeholder image">
                            <i></i>
                            </span>
                        </div>
                        <div class="media-body">
                    ...
                    <a href="#" class="list-group-item list-group-item-action media no-border">
                        <div class="media-left">
                            <span class="avatar avatar-md avatar-busy"><img class="media-object rounded-circle" src="<c:url value="/resources/images/portrait/small/avatar-s-9.png"/>" alt="Generic placeholder image">
                            <i></i>
                            </span>
                        </div>
                        <div class="media-body">
                    ...
                    <a href="#" class="list-group-item list-group-item-action media no-border">
                        <div class="media-left">
                            <span class="avatar avatar-md avatar-online"><img class="media-object rounded-circle" src="<c:url value="/resources/images/portrait/small/avatar-s-10.png"/>" alt="Generic placeholder image">
                            <i></i>
                            </span>
                        </div>
                        <div class="media-body">
                    ...
                    <a href="#" class="list-group-item list-group-item-action media no-border">
                        <div class="media-left">
                            <span class="avatar avatar-md avatar-online"><img class="media-object rounded-circle" src="<c:url value="/resources/images/portrait/small/avatar-s-11.png"/>" alt="Generic placeholder image">
                            <i></i>
                            </span>
                        </div>
                        <div class="media-body">
                    ...
                    <a href="#" class="list-group-item list-group-item-action media no-border">
                        <div class="media-left">
                            <span class="avatar avatar-md avatar-away"><img class="media-object rounded-circle" src="<c:url value="/resources/images/portrait/small/avatar-s-12.png"/>" alt="Generic placeholder image">
                            <i></i>
                            </span>
                        </div>
                        <div class="media-body">
...
<div class="row match-height">
                        ...
                        <section class="cd-horizontal-timeline">
                            <div class="timeline">
                                <div class="events-wrapper">
                                    <div class="events">
                                        <ol>
                                            <li><a href="#0" data-date="01/01/2018" class="selected">Tết Dương lịch</a></li>
                                            <li><a href="#0" data-date="14/02/2018">14-02 20-02 Tết Nguyên Đán</a></li>
                                            <li><a href="#0" data-date="25/04/2018">Giỗ Tổ Hùng Vương</a></li>
                                            <li><a href="#0" data-date="30/04/2018">Thống nhất Đất Nước</a></li>
                                            <li><a href="#0" data-date="01/05/2018">Quốc tế Lao động</a></li>
                                            <li><a href="#0" data-date="02/09/2018">Quốc khánh</a></li>
                                        </ol>
                                ...
                                <ol>
                                    <li class="selected" data-date="01/01/2018">
                                        <blockquote class="blockquote no-border">
                                            <div class="media">
                                                <div class="media-left">
                                                    <img class="media-object img-xl" src="<c:url value="/resources/images/portrait/small/avatar-s-5.png"/>" alt="Generic placeholder image">
                                                </div>
                                                <div class="media-body">
                                    ...
                                    <li data-date="14/02/2018">
                                        <blockquote class="blockquote no-border">
                                            <div class="media">
                                                <div class="media-left">
                                                    <img class="media-object img-xl" src="<c:url value="/resources/images/portrait/small/avatar-s-6.png"/>" alt="Generic placeholder image">
                                                </div>
                                                <div class="media-body">
                                                    Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                </div>
                                    ...
                                    <li data-date="25/04/2018">
                                        <blockquote class="blockquote no-border">
                                            <div class="media">
                                                <div class="media-left">
                                                    <img class="media-object img-xl" src="<c:url value="/resources/images/portrait/small/avatar-s-7.png"/>" alt="Generic placeholder image">
                                                </div>
                                                <div class="media-body">
                                                    Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                </div>
                                    ...
                                    <li data-date="30/04/2018">
                                        <blockquote class="blockquote no-border">
                                            <div class="media">
                                                <div class="media-left">
                                                    <img class="media-object img-xl" src="<c:url value="/resources/images/portrait/small/avatar-s-8.png"/>" alt="Generic placeholder image">
                                                </div>
                                                <div class="media-body">
                                                    Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                </div>
                                    ...
                                    <li data-date="01/05/2018">
                                        <blockquote class="blockquote no-border">
                                            <div class="media">
                                                <div class="media-left">
                                                    <img class="media-object img-xl" src="<c:url value="/resources/images/portrait/small/avatar-s-9.png"/>" alt="Generic placeholder image">
                                                </div>
                                                <div class="media-body">
                                                    Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                </div>
    ...
    <div class="col-xl-4 col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <img class="img-fluid" src="<c:url value="/resources/images/carousel/06.jpg"/>" alt="Card image cap">
                <div class="card-block">
