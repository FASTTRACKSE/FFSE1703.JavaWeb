		...
		<div class="main-menu-content">
			<ul id="main-menu-navigation" data-menu="menu-navigation"
				...
				<li class=" nav-item pbho_so"><a href="#"><i
						class="ft-users"></i><span data-i18n="" class="menu-title">Quản
							lý vắng nghỉ</span></a>
					<ul class="menu-content">
						<li><a href="<c:url value="/danhsachnhap"/>"
							class="menu-item">Danh sách nháp</a></li>
						<li><a href="<c:url value="/danhsachcho"/>" class="menu-item">Danh
								sách chờ duyệt</a></li>
						<li><a href="<c:url value="/danhsachduyet"/>"
							class="menu-item">Danh sách đã duyệt</a></li>
						<li><a href="<c:url value="/danhsachbituchoi"/>"
