				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a
						href='<c:url value="/quantrinhansu/hosonhanvien/view/${maNv }" />'>Thông
							Tin Nhân Viên</a></li>
					<li class="breadcrumb-item"><a
								href='<c:url value="/QuanTriNhanSu/quanlihopdong/viewOneHopDong/${maNv}" />'>Hợp Đồng Nhân Viên</a></li>
					<li class="breadcrumb-item active">Sửa Hợp Đồng</li>
				</ol>
			</div>
		</div>
<form:form class="form"  method="POST" modelAttribute="hopDongPikalong" action="/ffse-fbms/QuanTriNhanSu/quanlihopdong/edithd">
	<div class="form-body">
