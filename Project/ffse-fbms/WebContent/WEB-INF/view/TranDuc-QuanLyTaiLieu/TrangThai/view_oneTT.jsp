					...
					<div class="row breadcrumbs-top">
						<div class="breadcrumb-wrapper col-xs-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">Thông tin trạng thái</li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Thông tin trạng thái</h4>
									...
									<div class="table-responsive">
										<table class="table">
											<tr>
												...
												<td><label>Tên trạng thái</label> <input
													class="form-control" value="${TrangThai.tenTT}"
													placeholder="Tên Trạng Thái" readonly /></td>
											</tr>
										</table>
									</div>
								</div>
