									...
									<tbody>
										<c:forEach var="dn" varStatus="counter" items="${list}">
											<tr>
												...
												<td>${dn.getGhi_chu()}</td>
												<td><c:if test="${dn.getTinh_trang() == 2 }">
												...
												<td><a href="dontuchoi2/${dn.getId_don()}"><button class="btn-warning">Từ Chối</button></a></td>
