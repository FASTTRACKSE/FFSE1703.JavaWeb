...
<div class="app-content content container-fluid">
	<div class="content-wrapper">
		...
		<div>
		<div class="col-md-5">
		<h1><a href='<c:url value="/Quanlyvangnghi1703004/danhsachngaynghi" />'><i class="icon-arrow-left"></i></a></h1>
		</div>
		...
		<br>
            ...
            <input class="form-control" value="${list.soNgayDaNghi}" readonly />
            <label><spring:message code="label.songayconlai" /></label> 
            <input class="form-control" value="${list.soNgayConLai}" readonly />       
