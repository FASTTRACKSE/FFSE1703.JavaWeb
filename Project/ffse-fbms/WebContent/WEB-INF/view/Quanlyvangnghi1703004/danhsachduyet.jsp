	...
	<div class="content-wrapper">
		...
		<div class="container">
			...
			<c:forEach var="nv" items="${danhsachduyet}">
					...
					<td><h2><a href="deleteBrowse/${nv.id }"> <i class='fa fa-trash'onclick="return confirm('Bạn có muốn xóa sinh viên này?');"></i></a></h2>
						<h2><a   href="viewDuyet/${nv.id }"><i class="icon-eye"></i></a> </h2>
					</td>
						</tr>
				</c:forEach>
				</tbody>
