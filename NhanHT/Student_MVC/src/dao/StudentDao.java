...
public class StudentDao {
	...
	public List<Student> getStudent(int start, int end) {
		String sql = "select * from SinhVien limit " + start + "," + end;
	...
	public int save(Student p) {
		String sql = "insert into SinhVien(MaSv,TenSv,NamSinh,Email,DiaChi,LopHoc,Avatar) values('" + p.getMaSv()
	...
	public int update(Student p) {
		String sql = "update SinhVien set MaSv='" + p.getMaSv() + "', TenSv='" + p.getTenSv() + "', NamSinh='"
