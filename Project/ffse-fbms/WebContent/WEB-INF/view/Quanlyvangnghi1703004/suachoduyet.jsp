	...
	<div class="content-wrapper">
		...
		<div class="content-body">
			<div class="main-content">
				<h1>
					<a href='<c:url value="/Quanlyvangnghi1703004/danhsachcho" />'><i
				...
				<form:form method="POST" modelAttribute="suachoduyet">
					...
					<div class="col-md-2">
						<button type=submit
							...
							formaction="<%=request.getContextPath()%>/Quanlyvangnghi1703004/updatenhap/tuchoi">
							<spring:message code="label.tuchoi" />
						</button>
					</div>
					<div class="col-md-4">
						<div class="col-md-2">
							<button type="submit"
								...
								formaction="<%=request.getContextPath()%>/Quanlyvangnghi1703004/updateduyet/duyet">
								<spring:message code="label.duyet" />
							</button>
						</div>
					</div>
