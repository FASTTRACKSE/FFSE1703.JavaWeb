	...
	<table class="table table-striped">
		...
		<c:forEach var="sv" varStatus="counter" items="${list}">
			<tr>
				...
				<td>${sv.phone}</td>
				<td>${sv.classes}</td>
				<td><img src="<c:url value="/upload/${sv.hinhAnh}" />" width="60" height="80"></td>
				<td>					
	...
	<center>
	   <ul class="pagination">
                ...
                <li><c:if test="${page gt 1}">
                        <a href="/SinhVienSpringMVC/1"><button type="button" class="btn btn-warning btn-circle">
                        first
                    </button></a>
                    <a href="/SinhVienSpringMVC/${page-1}"><button type="button" class="btn btn-warning btn-circle">
                        ${page -1}
                    </button></a>
                    </c:if></li>
                ...
                <li><c:if test="${page lt soTrang}">
                    ...
                    <a href="/SinhVienSpringMVC/${soTrang}"><button type="button" class="btn btn-warning btn-circle">
                        last
                    </button></a>
                    </c:if></li>
            </ul>
